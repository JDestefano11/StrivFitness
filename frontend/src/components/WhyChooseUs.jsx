...
import gear from "../../public/assets/pexels-victorfreitas-791763.jpg";
...
const WhyChooseUs = () => {
    ...
    const animateElements = () => {
      ...
      const animate = (currentTime) => {
        ...
        if (headingRef.current) {
          ...
          headingRef.current.style.transform = `translateY(${20 * (1 - easeOutProgress)}px)`;
        }
        
        // Animate points with staggered delay
        pointsRef.current.forEach((point, index) => {
          if (point) {
            const delayedProgress = elapsedTime > (index * 120) ? (elapsedTime - (index * 120)) / duration : 0;
        ...
        if (testimonialRef.current && elapsedTime > 600) {
          ...
          testimonialRef.current.style.transform = `translateY(${20 * (1 - easedProgress)}px)`;
        }
  ...
  const features = useMemo(() => [
    {
      icon: (
        <svg className="w-10 h-10 text-[#efc75e]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "Our products are designed by fitness experts and athletes to provide top-tier performance, durability, and comfort. Every item is crafted to support your unique fitness journey."
    },
    {
      icon: (
        <svg className="w-10 h-10 text-[#efc75e]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "Thousands of happy customers have experienced significant improvements in their workouts with our gear. Whether you're a beginner or a seasoned pro, our products are here to help you level up."
    },
    {
      icon: (
        <svg className="w-10 h-10 text-[#efc75e]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "We stand by the quality of our products. If you're not 100% satisfied with your purchase, return it within 30 days for a full refund. No questions asked."
    },
    {
      icon: (
        <svg className="w-10 h-10 text-[#efc75e]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "We ship at warp speed to your doorstep—100% FREE. Changed your mind? Send it back with zero hassle. Your satisfaction is our mission."
    }
  ], []);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        >
          <div className="inline-flex items-center justify-center mb-3">
            ...
            <span className="mx-4 text-[#efc75e] text-sm font-bold tracking-widest uppercase font-['Rajdhani']">Why Choose Us</span>
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-6 font-['Rajdhani'] tracking-wide uppercase">
            Transform Your <span className="text-[#efc75e] relative">
              Fitness Journey
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative">
              ...
              <div 
                ref={testimonialRef}
                className="absolute bottom-8 left-8 z-30 max-w-[280px] md:max-w-[320px]"
                style={{ opacity: 0, transform: "translateY(20px)" }}
              >
                <div className="bg-black/80 backdrop-blur-sm rounded-xl p-5 border border-[#efc75e]/30 will-change-transform">
                  <svg
                    className="w-8 h-8 text-[#efc75e] mb-3"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <p className="text-white text-base italic mb-3">
                    "Striv Fitness has completely transformed my workout routine. The gear is amazing, and I feel stronger and more motivated than ever!"
                  </p>
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-white font-bold text-sm">Mike D.</p>
