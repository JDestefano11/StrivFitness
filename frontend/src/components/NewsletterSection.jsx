      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto text-base md:text-lg body-font mb-8">
          ...
          {/* Newsletter form with premium styling */}
          <div 
            ref={formRef}
            className="relative max-w-2xl mx-auto transition-all duration-500 group"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
            {[
              ...
              },
              {
                ...
                description: "Get subscriber-only discounts and special promotions."
              },
              {
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                description: "Access to premium workout guides and nutrition plans."
              }
            ].map((benefit, index) => (
              <div key={index} className="flex flex-col items-center text-center p-6 bg-black/30 backdrop-blur-sm border border-gray-800 rounded-lg transition-all duration-300 hover:border-[#efc75e]/30">
                <div className="w-12 h-12 rounded-full bg-[#efc75e]/10 flex items-center justify-center mb-4 text-[#efc75e]">
                  {benefit.icon}
                </div>
                <h3 className="text-xl font-bold text-white mb-2 heading-font">{benefit.title}</h3>
                <p className="text-gray-400 text-sm body-font">{benefit.description}</p>
              </div>
            ))}
          </div>
        </div>
