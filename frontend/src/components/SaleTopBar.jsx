    ...
    <div className="w-full bg-[#0f0f0f] border-b border-[#efc75e]/20 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative">
        <div className="grid grid-cols-3 h-10 relative">
          ...
          <div className="col-span-1 flex items-center justify-start xl:pl-8">
            <a 
          ...
          <div className="col-span-1 flex items-center justify-end xl:pr-8">
            {/* Instagram */}
            <a 
              href="https://instagram.com/strivfitness" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-white hover:text-[#efc75e] transition-colors duration-200 hover:scale-110 transform mx-2"
            ...
            {/* Facebook */}
            <a 
              href="https://facebook.com/strivfitness" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-white hover:text-[#efc75e] transition-colors duration-200 hover:scale-110 transform mx-2"
              aria-label="Facebook"
            ...
            {/* LinkedIn */}
            <a 
              href="https://linkedin.com/company/strivfitness" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-white hover:text-[#efc75e] transition-colors duration-200 hover:scale-110 transform mx-2"
              aria-label="LinkedIn"
